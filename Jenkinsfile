                    ...
                    stages {
                        ...
                        stage("Run tests") {
                            steps {
                                ...
                                TEST_INTEGRATION_DEST=3 CONTAINER_NAME=${CONTAINER_NAME}-3 TEST_SKIP_INTEGRATION=1 TESTFLAGS="-test.run Test(DockerSwarmSuite|DockerDaemonSuite|DockerExternalVolumeSuite|DockerPluginSuite)/" run_tests &
